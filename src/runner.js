...
} = require('graphql-schema-linter/lib/validator.js')
const { version } = require('../package.json')
const { Command } = require('commander')
const { Configuration } = require('graphql-schema-linter/lib/configuration.js')
const { loadSchema } = require('graphql-schema-linter/lib/schema.js')
const {
